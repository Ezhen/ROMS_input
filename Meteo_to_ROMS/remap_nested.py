...
def remap_nested(tart, tend, src_file, src_varname, src_grd, dst_grd, dmax=20, cdepth=0, kk=0,dst_dir='./'):
	...
	dst_varname_time_units = 'days since 2000-01-01 00:00:00'
	...
	dst_varname_time_field = 'pair_time field'
        ...
        dst_varname = 'Pair'
        dimensions = ('pair_time', 'erho', 'xrho')
        long_name = 'surface air pressure'
        units = 'millibar'
        field = 'Pair, scalar, series'
        #nc.createVariable('lon', 'f8', ('erho', 'xrho'))
        ...
        #nc.createVariable('lat', 'f8', ('erho', 'xrho'))
	...
	dst_varname_time_field = 'cloud_time field'
        ...
        wts_file = 'remap_weights_PUSSY_to_TRANSCHILD_bilinear_t_to_rho.nc'
        dst_varname = 'cloud'
        dimensions = ('cloud_time', 'erho', 'xrho')
	...
	dst_varname_time_field = 'wind_time field'
        ...
        wts_file = 'remap_weights_PUSSY_to_TRANSCHILD_bilinear_t_to_rho.nc'
        dst_varname = 'Uwind'
        dimensions = ('wind_time', 'erho', 'xrho')
	...
	dst_varname_time_field = 'tair_time field'
        ...
        wts_file = 'remap_weights_PUSSY_to_TRANSCHILD_bilinear_t_to_rho.nc'
        dst_varname = 'Tair'
        dimensions = ('tair_time', 'erho', 'xrho')
	...
	dst_varname_time_field = 'qair_time field'
        ...
        wts_file = 'remap_weights_PUSSY_to_TRANSCHILD_bilinear_t_to_rho.nc'
        dst_varname = 'Qair'
        dimensions = ('qair_time', 'erho', 'xrho')
	...
	dst_varname_time_field = 'rain_time field'
        ...
        wts_file = 'remap_weights_PUSSY_to_TRANSCHILD_bilinear_t_to_rho.nc'
        dst_varname = 'rain'
        dimensions = ('rain_time', 'erho', 'xrho')
	...
	dst_varname_time_field = 'ocean_time field'
        ...
        wts_file = 'remap_weights_PUSSY_to_TRANSCHILD_bilinear_t_to_rho.nc'
        dst_varname = 'PARout'
        dimensions = ('ocean_time', 'erho', 'xrho')
	...
	dst_varname_time_field = 'evap_time field'
        ...
        dimensions = ('evap_time', 'erho', 'xrho')
	...
	dst_varname_time_field = 'runoff_time field'
        ...
        wts_file = 'remap_weights_PUSSY_to_TRANSCHILD_bilinear_t_to_rho.nc'
        dst_varname = 'Runoff'
        dimensions = ('runoff_time', 'erho', 'xrho')
