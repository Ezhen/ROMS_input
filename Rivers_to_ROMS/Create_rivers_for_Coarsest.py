...
nc.variables['river_Xposition'][:]=[37,17,21,11]
...
nc.variables['river_Eposition'][:]=[63,37,26,95]
...
nc.variables['river_transport'][:,2]=np.concatenate((Rhine+Maas,Rhine+Maas,Rhine+Maas,Rhine+Maas,Rhine+Maas,Rhine+Maas,Rhine+Maas,Rhine+Maas,Rhine+Maas,Rhine+Maas),axis=0)
#nc.variables['river_transport'][:,2]=Maas
#nc.variables['river_transport'][:,3]=-Rhine
nc.variables['river_transport'][:,3]=np.concatenate((Seine,Seine,Seine,Seine,Seine,Seine,Seine,Seine,Seine,Seine),axis=0)
...
nc.variables['river_temp'][:,:,2]=np.concatenate((0.15*Maas_t+0.85*Rhine_t,0.15*Maas_t+0.85*Rhine_t,0.15*Maas_t+0.85*Rhine_t,0.15*Maas_t+0.85*Rhine_t,0.15*Maas_t+0.85*Rhine_t,0.15*Maas_t+0.85*Rhine_t,0.15*Maas_t+0.85*Rhine_t,0.15*Maas_t+0.85*Rhine_t,0.15*Maas_t+0.85*Rhine_t,0.15*Maas_t+0.85*Rhine_t),axis=0)
#nc.variables['river_temp'][:,:,2]=Maas_t
#nc.variables['river_temp'][:,:,3]=Rhine_t
nc.variables['river_temp'][:,:,3]=np.concatenate((Seine_t,Seine_t,Seine_t,Seine_t,Seine_t,Seine_t,Seine_t,Seine_t,Seine_t,Seine_t),axis=0)
