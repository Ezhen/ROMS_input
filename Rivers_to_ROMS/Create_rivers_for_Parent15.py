...
nc = Dataset('/home/eivanov/coawst_data_prrocessing/Temporal/Input_files_to_ROMS/Rivers_parent15_Thames.nc', 'w', format='NETCDF4')
...
nc.variables['river_Xposition'][:]=[39,1,13]#,11]
...
nc.variables['river_Eposition'][:]=[70,24,18]#,95]
...
for i in range(Nr):
	nc.variables['river_salt'][:,:,i]=np.ones((365*3,15))
